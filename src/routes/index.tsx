...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Ôn luyện thi năm 1 - Ngành Cốp pha" },
      {
        name: "description",
        content:
    ...
    <div className="min-h-screen bg-slate-50/50">
      ...
      <header className="relative overflow-hidden bg-white border-b border-slate-200">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-12 sm:py-20">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900 mb-4">
            Ôn luyện thi năm 1 - Ngành Cốp pha
          </h1>
          <p className="max-w-2xl text-lg sm:text-xl text-slate-600 leading-relaxed">
            Hệ thống luyện thi trắc nghiệm Đúng/Sai giúp bạn tự tin vượt qua kỳ thi chuyển giai đoạn
            1 ngành Cốp pha tại Nhật Bản.
          </p>
        </div>
      </header>
            ...
            {[
              {
                icon: Clock,
                title: "Thời gian",
                text: "30 phút cho mỗi đề thi, đếm ngược tự động.",
              },
              {
                icon: AlertTriangle,
                title: "Lưu ý",
                text: "Không được quay lại sửa câu đã trả lời.",
              },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="group border-slate-200 hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300">
              ...
              <CardContent>
                <Button
                  asChild
                  className="w-full bg-slate-900 hover:bg-indigo-600 text-white shadow-none transition-all duration-300"
                >
                  <Link to="/vocab">Học từ vựng</Link>
                </Button>
              </CardContent>
            </Card>
              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-slate-100 text-slate-600 group-hover:bg-indigo-100 group-hover:text-indigo-700"
                    >
      ...
      <footer className="mx-auto max-w-5xl px-4 py-12 text-center">
        <p className="text-xs text-slate-400 font-medium tracking-wide uppercase">
          Hệ thống hỗ trợ thực tập sinh · Dữ liệu chuẩn cốp pha 2026 havietho.jp
        </p>
      </footer>
    </div>
  );
